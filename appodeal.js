...
const eventHandlers = {
  ...
  onInterstitialExpired: 'onInterstitialExpired',
  ...
  onRewardedVideoDidLoadAdIsPrecache: 'onRewardedVideoDidLoadAdIsPrecache',
  onRewardedVideoFailedToLoad: 'onRewardedVideoFailedToLoad',
  //onRewardedVideoDidFailToPresent: 'onRewardedVideoDidFailToPresent',
  onRewardedVideoDidFailToPresentWithError: 'onRewardedVideoDidFailToPresentWithError',
  ...
  onRewardedVideoClicked:'onRewardedVideoClicked',
  onRewardedVideoExpired:'onRewardedVideoExpired',
  onRewardedVideoPresented:'onRewardedVideoPresented',
...
module.exports = {
  ...
  initialize: (appKey, adTypes, callback) => RNAppodeal.initialize(appKey, adTypes, callback),
  ...
  disableNetwork: (network) => RNAppodeal.disableNetwork(network),
